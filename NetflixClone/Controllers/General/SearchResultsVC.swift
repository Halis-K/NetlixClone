...
//  NetflixClone
//
//  Created by Halis Kayar on 28.01.2023.
//
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName) { [weak self] result in
            ...
            case .success(let videoElement):
                self?.delegate?.searchResultsVCDidTapItem(TitlePreviewViewModel(title: title.originalTitle ?? "", youtubeView: videoElement, titleOverview: title.overview ?? ""))
